...
import { AppstoreOutlined, FileAddOutlined, UnorderedListOutlined } from '@ant-design/icons';
...
const Sidebar = () => {
  ...
  const items = [
    {
      ...
      children: [
        { key: '1', label: 'Add New Expense', icon: <FileAddOutlined />, onClick: () => handleNavigation("/expenses/add") },
        { key: '2', label: 'All Expenses', icon: <UnorderedListOutlined />, onClick: () => handleNavigation("/expenses/all") },
      ],
    },
    {
      key: 'sub2',
      ...
      icon: <AppstoreOutlined />,
      children: [
        { key: '3', label: 'Add New Category', icon: <FileAddOutlined />, onClick: () => handleNavigation("/categories/add") },
        { key: '4', label: 'All Categories', icon: <UnorderedListOutlined />, onClick: () => handleNavigation("/categories/all") },
      ],
    },
    {
      key: 'sub3',
  ...
  return (
    <div className="h-screen w-64 bg-gray-800 text-white flex flex-col p-4 shadow-lg border-t-2">
      {/* Logo */}
      <div className="text-3xl font-bold mb-8 text-center cursor-pointer select-none" onClick={() => navigate("/")}>
        Logo
      </div>
